...
wget -L https://raw.githubusercontent.com/gogins/csound-extended/develop/WebAssembly/examples/CsoundAC.js -P CsoundForAndroid/CsoundApplication/src/main/assets/examples/Gogins
